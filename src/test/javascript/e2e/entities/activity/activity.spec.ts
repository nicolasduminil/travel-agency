...
describe('Activity e2e test', () => {
  ...
  it('should load Activities', async () => {
    ...
    expect(await activityComponentsPage.getTitle()).to.eq('travelAgencyApp.activity.home.title');
  ...
  it('should load create Activity page', async () => {
    ...
    expect(await activityUpdatePage.getPageTitle()).to.eq('travelAgencyApp.activity.home.createOrEditLabel');
  ...
  it('should create and save Activities', async () => {
    ...
    await promise.all([
      activityUpdatePage.setActivityDescriptionInput('activityDescription'),
      activityUpdatePage.activityTypeSelectLastOption(),
      activityUpdatePage.locationSelectLastOption(),
    ]);

    expect(await activityUpdatePage.getActivityDescriptionInput()).to.eq(
      'activityDescription',
      'Expected ActivityDescription value to be equals to activityDescription'
    );
  ...
  it('should delete last Activity', async () => {
    ...
    expect(await activityDeleteDialog.getDialogTitle()).to.eq('travelAgencyApp.activity.delete.question');
