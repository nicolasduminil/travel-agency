...
describe('Customer e2e test', () => {
  ...
  it('should load Customers', async () => {
    ...
    expect(await customerComponentsPage.getTitle()).to.eq('travelAgencyApp.customer.home.title');
  ...
  it('should load create Customer page', async () => {
    ...
    expect(await customerUpdatePage.getPageTitle()).to.eq('travelAgencyApp.customer.home.createOrEditLabel');
  ...
  it('should create and save Customers', async () => {
    ...
    await promise.all([
      ...
      customerUpdatePage.customerGenderSelectLastOption(),
      customerUpdatePage.setCustomerBirthDateInput('2000-12-31'),
      customerUpdatePage.dealSelectLastOption(),
    ]);

    expect(await customerUpdatePage.getCustomerNameInput()).to.eq(
      'customerName',
      'Expected CustomerName value to be equals to customerName'
    );
    expect(await customerUpdatePage.getCustomerBirthDateInput()).to.eq(
      '2000-12-31',
      'Expected customerBirthDate value to be equals to 2000-12-31'
    );
  ...
  it('should delete last Customer', async () => {
    ...
    expect(await customerDeleteDialog.getDialogTitle()).to.eq('travelAgencyApp.customer.delete.question');
