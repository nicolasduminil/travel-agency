...
public class CustomerResourceIT {
    ...
    private static final Gender DEFAULT_CUSTOMER_GENDER = Gender.M;
    private static final Gender UPDATED_CUSTOMER_GENDER = Gender.F;

    private static final LocalDate DEFAULT_CUSTOMER_BIRTH_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_CUSTOMER_BIRTH_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .customerBirthDate(DEFAULT_CUSTOMER_BIRTH_DATE);
        return customer;
    }
    /**
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCustomerGender()).isEqualTo(DEFAULT_CUSTOMER_GENDER);
        assertThat(testCustomer.getCustomerBirthDate()).isEqualTo(DEFAULT_CUSTOMER_BIRTH_DATE);
    }
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].customerBirthDate").value(hasItem(DEFAULT_CUSTOMER_BIRTH_DATE.toString())));
    }
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.customerBirthDate").value(DEFAULT_CUSTOMER_BIRTH_DATE.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCustomerGender()).isEqualTo(UPDATED_CUSTOMER_GENDER);
        assertThat(testCustomer.getCustomerBirthDate()).isEqualTo(UPDATED_CUSTOMER_BIRTH_DATE);
    }
