...
public class ActivityResourceIT {
    ...
    private static final ActivityType DEFAULT_ACTIVITY_TYPE = ActivityType.ADVENTURE;
    private static final ActivityType UPDATED_ACTIVITY_TYPE = ActivityType.ATTRACTION;
